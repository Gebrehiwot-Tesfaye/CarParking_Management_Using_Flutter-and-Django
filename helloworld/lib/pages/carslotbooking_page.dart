...
class CarSlotBookingPage extends StatelessWidget {
  ...
  final int userId; // Add this field to pass userId

  CarSlotBookingPage({super.key, required this.userId}); // Update constructor
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      AboutScreen(userId: userId), // Pass the userId here
                ),
              );
            },
          ),
